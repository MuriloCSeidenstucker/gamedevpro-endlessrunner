...
public class AudioController : MonoBehaviour
{
    ...
    {
        _gameSaver.LoadGame();
        MasterVolume = _gameSaver.CurrentAudioPreferences.MasterVolume;
        MusicVolume = _gameSaver.CurrentAudioPreferences.MusicVolume;
        SFXVolume = _gameSaver.CurrentAudioPreferences.SFXVolume;
    }
